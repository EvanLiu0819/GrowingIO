...
在 GrowingIO 平台上使用可视化圈选指标功能需要使用 iframe 来加载目标页面。如果您的网站禁止了以 iframe 形式加载，就无法正常使用圈选功能定义指标，需要设置允许以 iframe 形式加载。

将服务器端配置修改成X-Frame-Options: Allow-From [http://gio.growingio.com，\](http://gio.growingio.com，\) 如果您的网站是 https ，请使用X-Frame-Options: Allow-From [https://gio.growingio.com](https://gio.growingio.com) 。
